...
class Window(QWidget):
    ...
    def startCamera(window):
        ...
        window.timer.start (40) #update every 40ms
    ...
    def captureImages(window):
        ...
        if window.captureIndex < 4:
            ...
            QTimer.singleShot(6500,window.reset)
    ...
    def photostrip(window):
        """
         ...
         Function: Loads the captured image files and arranges them in a grid to create a photostrip, which is then saved as an timed stamped image file.
    ...
    def previewPhotostrip(window): 
        """
         Displays the generated photostrip in the GUI.
